...
import { Palette, Trash2, Download, AlertCircle, ArrowLeft } from 'lucide-react';
...
import StepProgress from './StepProgress'; // ✅ update path as needed
...
const removeArrayItem = (section, index) => {
  ...
  const updateResumeDetails = async (thumbnailLink) => {
    try {
      ...
      await axiosInstance.put(API_PATH.RESUME.UPDATE(resumeId), {
        ...resumeData,
