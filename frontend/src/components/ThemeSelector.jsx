...
const ThemeSelector = ({selectedTheme , setSelectedTheme, resumeData , onClose}) => {
   ...
   const handleThemeSelection= () =>{
    setSelectedTheme(selectedTemplate.theme) // ✅ Correct
  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            <button className='w-full sm:w-auto-flex items-center justufy-center gap-3 px-6 py-3 bg-gradient-to-r
            from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 transition-all ashadow-lg hover:shadow-xl'
        ...
        <div className='grid frid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8'>
