...
export const ProfileInfoCard = () => {
    ...
    const { user, clearUser } = useContext(UserContext); // ✅ Fix here
...
export const TemplateCard = ({ thumbnailImg, isSelected, onSelect }) => {
    return (
        <div className={`group h-auto md:h-[300px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer
       ...
       `}
            ...
            {thumbnailImg ? (
                ...
                group-hover:scale-110 transition-transform duration-700' />
                    ...
                    <div className='absolute inset-0 bg-gradient-to-t from-white/00 via-transparent
 to-transparent opacity-0 group-hover:opacity-100
                transition-opacity duration-300'>
                        ...
                        ground-hover:opacity-100 transition-opacity duration-300'>
                            </div>
                ...
                <div className='w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-600
                to-fuchisa-50'>
                    <div className='w-12 h-12 bg-gradient-to-br from-violet-500 to-fuchisa-500 rounded-2xl flex 
                    items-center justidy-center mb-3'>
